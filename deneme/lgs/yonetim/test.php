...
<?php
	...
	ukas_giris("ayar.php", "yntci/test.php", "<p>Lütfen boş bırakmayınız!</p>", "<p>Kullanıcı adı veya şifre hatalı!</p>");
	// Ayar dosyası, Giriş yapıldıktan sonra yönlendirilecek yer, Uyarı mesajı, Hata mesajı
?>
<strong>Yönetici Parolası İle Giriş Yap!</strong><br />
...
<title>Yönetici Parolası İle Giriş Yap!</title>
<hr>
<?php
